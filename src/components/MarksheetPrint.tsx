  ...
  return (
    <div className="print-area hidden print:block bg-white p-8 max-w-4xl mx-auto border-2 border-slate-800 text-slate-900 font-serif">
      ...
      <div className="text-center border-b-2 border-slate-800 pb-4 mb-6">
        ...
        <p className="text-sm font-medium mt-1 text-slate-800">{examName || 'CBCSS UG DEGREE EXAMINATION'}</p>
      </div>
      ...
      <div className="border-2 border-slate-800 p-4 mb-6 grid grid-cols-4 gap-4 text-center bg-slate-50">
        ...
        <div>
          <div className="text-[11px] uppercase text-slate-600 font-semibold">Total Marks</div>
          <div className="text-xl font-bold text-slate-900">{summary.totalMarks} / {summary.maxMarks} ({summary.percentage}%)</div>
        </div>
        <div>
          <div className="text-[11px] uppercase text-slate-600 font-semibold">SCPA / Grade</div>
