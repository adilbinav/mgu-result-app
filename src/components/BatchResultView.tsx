          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="grid grid-cols-6 gap-2 text-center">
              {['A+', 'A', 'B+', 'B', 'C', 'F'].map(grade => {
                ...
                return (
                  <div key={grade} className="bg-slate-50 border border-slate-200 rounded-xl p-2.5">
                    <div className="text-xs font-bold text-slate-600">Grade {grade}</div>
                    <div className="text-lg font-black text-slate-900 mt-0.5">{count}</div>
                    <div className="text-[11px] text-slate-400 font-medium">{pct.toFixed(0)}%</div>
                  </div>
                );
              })}
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3 bg-slate-50/50">
              <h3 className="font-bold text-slate-900 text-base flex items-center gap-2">
                ...
                <span>Class Leaderboard & Mark Sheet</span>
              </h3>
              <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 relative">
            <div className="flex items-center justify-between border-b pb-4 mb-4">
              <div>
                <h3 className="font-bold text-lg text-slate-900">{inspectedStudent.name}</h3>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6 text-center">
              <div className="bg-blue-50 p-3 rounded-xl border border-blue-100">
                <div className="text-xs uppercase text-blue-600 font-bold">SCPA</div>
                <div className="text-2xl font-black text-blue-900">{inspectedStudent.summary.scpa.toFixed(2)}</div>
              </div>
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200">
                <div className="text-xs uppercase text-slate-500 font-bold">Total Marks</div>
                <div className="text-2xl font-black text-slate-800">{inspectedStudent.summary.totalMarks} / {inspectedStudent.summary.maxMarks}</div>
              </div>
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200">
                <div className="text-xs uppercase text-slate-500 font-bold">Result</div>
                <div className={`text-xl font-black uppercase mt-0.5 ${inspectedStudent.summary.result.toLowerCase() === 'passed' ? 'text-emerald-700' : 'text-rose-700'}`}>
